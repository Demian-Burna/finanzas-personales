...
/**
 * Searchable category picker — renders dropdown in a portal so it is
 * never clipped by overflow:hidden parents or flex containers on mobile.
 */
export function CategoryCombobox({
  ...
  const [pos, setPos] = useState<DropdownPos>({ top: 0, left: 0, width: 220 })
